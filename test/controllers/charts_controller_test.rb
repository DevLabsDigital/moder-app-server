...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { label: @chart.label, situation_label: @chart.situation_label } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { label: @chart.label, situation_label: @chart.situation_label } }
